...
- Use `pnpm`.
- Public packages are `@trytilde/harness-sdk`, `@trytilde/harness-sdk-react`, `@trytilde/harness-sdk-vercel-ai-node`, `@trytilde/harness-sdk-vercel-ai-react`, and `@trytilde/cli`.
